...
<div class="flex bg-orange-50 items-center justify-between py-5 md:px-20 px-5">
    ...
    <ul id="navbar-menu" class="bg-black/80 p-3 -px-5 text-white z-50 backdrop-blur-sm duration-700 transtion-all  -left-[100%] absolute min-w-[70vw] justify-center flex gap-8 top-0 flex-col  min-h-screen">
        <li>
            <a href="/" class="text-xl pl-5 hover:text-orange-400">Acceuil</a>
        </li>
        <li>
