...
@section('content')
    <form action="" method="post">
        ...
        <div class="p-3 bg-white w-full fixed bottom-0 flex shadow-lg justify-between">
            <div x-show="false">
                <a href="{{ route('front.inscription.pack_picking') }}"  class="button today-btn text-white bg-orange-700 !bg-primary-700 dark:bg-orange-600 dark:!bg-primary-600 hover:bg-orange-800 hover:!bg-primary-800 dark:hover:bg-orange-700 dark:hover:!bg-primary-700 focus:ring-4 focus:ring-orange-300 focus:!ring-primary-300 font-medium rounded-lg text-sm px-5 py-2 text-center">Précedent</a>
            </div>
            <div>
                <button type="submit" formtarget="#form"  class="button today-btn text-white bg-orange-700 !bg-primary-700 dark:bg-orange-600 dark:!bg-primary-600 hover:bg-orange-800 hover:!bg-primary-800 dark:hover:bg-orange-700 dark:hover:!bg-primary-700 focus:ring-4 focus:ring-orange-300 focus:!ring-primary-300 font-medium rounded-lg text-sm px-5 py-2 text-center">Terminé</button>
            </div>
        </div>
    </form>
@endsection
