...
@section('content')
    ...
    <form action="" method="post">
        ...
        <div class="p-3 bg-white w-full fixed bottom-0 flex shadow-lg items-center justify-between">
            <div x-show="false">
